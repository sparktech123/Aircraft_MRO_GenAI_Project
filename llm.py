...
NOTE: This file was converted so the whole chat app runs inside
run_chat_assistant() instead of at import time. Call run_chat_assistant()
from main_app.py. st.set_page_config() is NOT called here anymore — the
...
def run_chat_assistant():
    """Entry point — call this from main_app.py to render the whole chat
    assistant UI."""
